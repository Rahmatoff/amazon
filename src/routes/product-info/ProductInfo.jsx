          ...
          <div>
            ...
            <h2>{productData.name}</h2>
            {
              ...
              new Array(productData?.ratings).fill("#").map(() => 
                <BsStarFill className={c.icon} key={uuidv4()}/>
              ) : 
              <>
              { 
              ...
              <BsStarHalf className={c.icon}/>
              </>
            }
          </div>
            <div>
              <p className={c.newProductDescription}>{productData.description}</p>
              <p className={c.newProductPricee}><span>Price:</span>  ${productData.price}</p>
